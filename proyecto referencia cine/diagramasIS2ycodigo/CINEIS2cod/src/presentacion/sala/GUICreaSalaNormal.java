...
public class GUICreaSalaNormal extends JFrame{
	
	private static final long serialVersionUID = 1L;
	
	public GUICreaSalaNormal(){
		super("Crea Sala Normal");
		...
		seccionsuperior.add(new JLabel("Introduzca los datos necesarios para crear una nueva sala normal: "));
		...
		aceptar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				try{
					...
					datos.setNum_anuncios(Integer.parseInt(anuncios.getText()));
