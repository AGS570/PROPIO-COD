...
public class GUIActualizaSalaNormal extends JFrame {

	private static final long serialVersionUID = 1L;

	public GUIActualizaSalaNormal() {
		super("Actualizar Sala Normal");
		...
		seccionsuperior.add(new JLabel("Introduzca los datos preferidos para actualizar una sala normal existente: "));
		...
		seccionmedia.add(new JLabel("Numero de anuncios: "));
		JTextField anuncios = new JTextField(2);
		seccionmedia.add(anuncios);
		...
		aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TSalaNormal datos = new TSalaNormal();
				...
				try { datos.setNum_anuncios(Integer.parseInt(anuncios.getText())); } catch (NumberFormatException ex) {}
