...
public class GUIMostrarSala extends JFrame{
	
	private static final long serialVersionUID = 1L;

	public GUIMostrarSala(){
		super("Mostrar Sala");
		...
		seccionAlta.add(new JLabel("Introduzca el ID de la sala a buscar: "));
		...
		aceptar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstance().accion(EventosSala.MUESTRA_SALA, dato);
