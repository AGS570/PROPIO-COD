...
public class GUIQuitaSala extends JFrame {
	...
	public GUIQuitaSala() {
		...
		seccionAlta.add(new JLabel("Introduzca el ID de la sala a eliminar: "));
		...
		aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstance().accion(EventosSala.QUITA_SALA, dato);
