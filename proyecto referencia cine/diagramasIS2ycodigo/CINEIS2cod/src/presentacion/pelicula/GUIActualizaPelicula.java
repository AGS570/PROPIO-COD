...
public class GUIActualizaPelicula extends JFrame {

	private static final long serialVersionUID = 1L;
	
	public GUIActualizaPelicula(){
		...
		seccionAlta.add(new JLabel("Introduzca los datos preferidos para actualizar una pelicula existente:"));
		...
		aceptar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				if(!clasificacion.getText().isEmpty())
					datos.setClasificacion(clasificacion.getText());
				
				Controlador.getInstance().accion(EventosPelicula.ACTUALIZA_PELICULA, datos);
