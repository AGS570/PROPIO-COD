...
public class GUIMostrarPelicula extends JFrame {

	private static final long serialVersionUID = 1L;
	
	public GUIMostrarPelicula(){
		super("Mostrar Pelicula");
		...
		seccionAlta.add(new JLabel("Introduzca el ID de la pelicula a buscar: "));
		...
		aceptar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstance().accion(EventosPelicula.MUESTRA_PELICULA, dato);
