...
public class GUIDevolverVenta extends JFrame {
	...
	public GUIDevolverVenta() {
		...
		seccionAlta.add(new JLabel("Introduzca el ID de la venta que desea devolver: "));
		...
		aceptar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstance().accion(EventosVenta.DEVUELVE_VENTA, dato);
