...
public class GUIMostrarProyeccion extends JFrame{

	private static final long serialVersionUID = 1L;

	public GUIMostrarProyeccion(){
		...
		seccionAlta.add(new JLabel("Introduzca el ID de la proyeccion a buscar: "));
		...
		aceptar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstance().accion(EventosProyeccion.MUESTRA_PROYECCION, dato);
