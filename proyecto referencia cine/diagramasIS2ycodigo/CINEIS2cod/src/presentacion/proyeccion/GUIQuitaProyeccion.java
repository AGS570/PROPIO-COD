...
public class GUIQuitaProyeccion extends JFrame{

	private static final long serialVersionUID = 1L;

	public GUIQuitaProyeccion(){
		super("Quitar Proyeccion");
		...
		seccionAlta.add(new JLabel("Introduzca el ID de la proyeccion a eliminar: "));
		...
		aceptar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstance().accion(EventosProyeccion.QUITA_PROYECCION, dato);
