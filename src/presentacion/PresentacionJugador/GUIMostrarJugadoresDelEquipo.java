...
public class GUIMostrarJugadoresDelEquipo extends JFrame implements IGUI{
	
	private static final long serialVersionUID = 1L;

	public GUIMostrarJugadoresDelEquipo() {
		super("Mostrar los Equipos de un Jugador");
		...
		seccionAlta.add(new JLabel("Introduzca el id del jugador para mostrar sus equipos:"));
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				 if(id.getText().isEmpty()) {
			            JOptionPane.showMessageDialog(GUIMostrarJugadoresDelEquipo.this, 
			        ...
			        Controlador.getInstance().accion(Eventos.MOSTRAR_JUGADORES_DEL_EQUIPO, idJugador);
			        dispose();
			}
	...
	public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new GUIMostrarJugadoresDelEquipo();
            }
        });
    }
}